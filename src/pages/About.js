            ...
            <div className="about-information">
                <div className="card-information">
                    ...
                    <p className="card-desc">
                        Hi! My name is Alexi, and I'm from the Philippines. I'm
                        15 years old, turning 16 this year. I'm currently a
                        Grade 11 student in the STEM strand, and I plan to take
                        Computer Science in college. I've always loved coding
                        and computers in general.
                    </p>
                    <p className="card-desc">Aside from coding, I also love:</p>
                    <ul className="card-hobbies card-desc">
                        <li>Playing games like VALORANT and Minecraft!</li>
                        <li>Watching Netflix/Youtube</li>
                        <li>
                            <strike>Going to school</strike>
                        </li>
                    </ul>
                    <p
