                    ...
                    <div className="about-information">
                        <div className="card-information">
                            ...
                            <p className="card-desc">
                                Hi! My name is{' '}
                                <span className="highlight">Alexi</span>, and
                                I'm from the{' '}
                                <span className="highlight">Philippines</span>.
                                As of 2023, I'm now 16 years old! I'm currently
                                a Grade 11 STEM student, and plan to graduate
                                with a degree in{' '}
                            ...
                            <p className="card-desc">
                                {' '}
                                Ever since I was{' '}
                                <span className="highlight">young</span>, I've
                                always wanted to{' '}
                                <span className="highlight">learn</span> how to
                                code. It all{' '}
                                <span className="highlight">started</span> when
                                I was about{' '}
                                <span className="highlight">~7 years old</span>{' '}
                            ...
                            <ul className="card-hobbies card-desc">
                                <li className="card-hobby">
                                    Playing games like{' '}
                                    <span className="highlight">VALORANT</span>{' '}
                                    and{' '}
                                ...
                                <li className="card-hobby">
                                    Watching{' '}
                                    <span className="highlight">Netflix</span>/
                    ...
                    <div className="award-information">
                        <div className="card-information">
                            ...
                            <p className="card-desc awards">
                                An overview of my academic and extracurricular
                                awards achievements during my life so far.
                            </p>
                            <ul className="card-desc">
                                ...
                                <li className="card-hobby">
                                    Completed{' '}
                                    <span className="highlight">Junior HS</span>{' '}
                                    and moved up to{' '}
                                ...
                                <li className="card-hobby">
                                    Built many{' '}
                                    <Link to="/projects">projects</Link> while
                                    learning{' '}
                                    <span className="highlight">
                                        how to code
                                    </span>
